...
# Load dataset
df = pd.read_csv("Analytics/Project4/kc_house_data.csv")
...
# Save graph
plt.savefig("Analytics/Project4/Graph/house_prices_line.png")
...
# Save graph
plt.savefig("Analytics/Project4/Graph/expensive_houses_bar.png")
...
# Save graph
plt.savefig("Analytics/Project4/Graph/bedroom_distribution.png")
...
plt.tight_layout()
plt.savefig("Analytics/Project4/Graph/price_trend.png")
plt.show()
...
plt.savefig("Analytics/Project4/Graph/price_category_stacked.png")
plt.show()
...
plt.tight_layout()
plt.savefig("Analytics/Project4/Graph/price_histogram.png")
plt.show()
